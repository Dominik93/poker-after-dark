...
@Component({
  selector: 'app-administration-games',
  templateUrl: './administration-games.component.html',
  animations: [
  ...
  styleUrls: ['./administration-games.component.css']

})
export class AdministrationGamesComponent implements OnInit {

  administrationMode: boolean = true;
